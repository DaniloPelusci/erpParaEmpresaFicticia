...
public class PesquisaFuncionario extends javax.swing.JDialog {
     ...
     */
    public PesquisaFuncionario(java.awt.Frame parent, boolean modal, Vasilhame telaPai) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        try {
            ...
            jTableFuncionario.setModel(funcionarioDAO.buscaLike(jTextFieldNome.getText()));
            jTableFuncionario.setRowSorter(new TableRowSorter(funcionarioDAO.buscaLike(jTextFieldNome.getText())));
