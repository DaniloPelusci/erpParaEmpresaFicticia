...
public class ListaPedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("E.B.O. Lista Pedido Não Finalizado");
    ...
    private void jTableClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableClientesMouseClicked
        ...
        String Idpedido = "" + jTableClientes.getValueAt(jTableClientes.getSelectedRow(), 2);// TODO add your handling code here:
        try {
            new Venda(Integer.parseInt(Id), Long.parseLong(Idpedido),0).setVisible(true);
