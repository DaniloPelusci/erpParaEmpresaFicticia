...
public class PesquisaProduto extends javax.swing.JDialog {
     ...
     */
    public PesquisaProduto(java.awt.Frame parent, boolean modal,Pedido telaPai) {
        super(parent, modal);
        initComponents();
   ...
   public void pesquisa(){
      Connection connection;
        try {
            ...
            jTableProduto.setModel(produtoDAO.buscaLikeVenda(jTextFieldNome.getText().toUpperCase()));
            jTableProduto.setRowSorter(new TableRowSorter(produtoDAO.buscaLikeVenda(jTextFieldNome.getText().toUpperCase())));
