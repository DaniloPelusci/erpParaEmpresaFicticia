 ...
 * @author E.B.O 2
 */
public class GerarRelatorio1 extends javax.swing.JFrame {
     ...
     */
    public GerarRelatorio1() {

    }

    GerarRelatorio1(Long idFunc) {
        initComponents();
        this.id = idFunc;
    ...
    private void jButtonGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGerarRelatorioActionPerformed
        if (validacao().isEmpty()) {
            try {
                ...
                String nome = "relatorioFim\\RelatorioVales.jasper";
                ...
                try {
                    ...
                    Logger.getLogger(GerarRelatorio1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerarRelatorio1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GerarRelatorio1().setVisible(true);
            }
        });
    }
