 ...
 * @author usuario
 */
public class RemessaVirtualLocacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFormattedTextDataInit = new javax.swing.JFormattedTextField();
        ...
        try {
            jFormattedTextDataInit.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(jFormattedTextDataInit, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jFormattedTextDataInit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton1)
                    .addComponent(jButton2))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(RemessaVirtualLocacao.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            String stringDataSalvar = jFormattedTextDataInit.getText();

            Date dataSalvar = new Date(format.parse(stringDataSalvar).getTime());
            pTestes.gerarBoletoLocacao(dataSalvar);
        } catch (SQLException ex) {
            Logger.getLogger(RemessaVirtualLocacao.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ParseException ex) {
            Logger.getLogger(RemessaVirtualLocacao.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemessaVirtualLocacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemessaVirtualLocacao().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField jFormattedTextDataInit;
    ...
    private String validacao() {
        ...
        if (!logica.LogicasPedido.validaData(jFormattedTextDataInit.getText())) {
            validar += "\n" + "data invalida  ";
            cont++;
    ...
    private void tabelaboletos() throws SQLException, ParseException {
        ...
        modeloBoletos = pedTestes.gerarboletoParaGerarLocacao(dataSalvar);

        this.modeloBoletosClass = modeloBoletos;
        System.err.println(modeloBoletosClass.size());
