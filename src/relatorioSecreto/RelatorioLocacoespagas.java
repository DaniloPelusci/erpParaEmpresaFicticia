 ...
 * @author E.B.O 2
 */
public class RelatorioLocacoespagas extends javax.swing.JFrame {

    /**
     * Creates new form Relatoriolocacoespagas
     */
    public RelatorioLocacoespagas() {
        initComponents();
    }
    ...
    private void jButtonGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGerarRelatorioActionPerformed
        if (validacao().isEmpty()) {
            ...
            try {
                ...
                String nome = "relatorioFim\\totalvalorpagoLocado.jasper";
                ...
                try {
                    ...
                    Logger.getLogger(RelatorioLocacoespagas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioLocacoespagas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioLocacoespagas().setVisible(true);
            }
        });
    }
