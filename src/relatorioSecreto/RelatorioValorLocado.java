 ...
 * @author E.B.O 2
 */
public class RelatorioValorLocado extends javax.swing.JFrame {

    /**
     * Creates new form Relatoriolocacoespagas
     */
    public RelatorioValorLocado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatorio de Valor Locado");
    ...
    private void jButtonGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGerarRelatorioActionPerformed
        if (validacao().isEmpty()) {
            ...
            try {
                ...
                String nome = "relatorioFim\\totalvalorLocado.jasper";
                ...
                try {
                    ...
                    Logger.getLogger(RelatorioValorLocado.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioValorLocado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioValorLocado().setVisible(true);
            }
        });
    }
